...
<div id="wcfusion_one_click_checkout_header" style="display: none;">
    <div class="wcfusion_one_click_checkout_module_list_header">
        <div class="wcfusion_one_click_checkout_module_left_header">
            <p><?php _e('wcFusion<span>'.WCFUSION_VERSION.'</span>','wcfusion') ?></p>
        </div>
        <div class="wcfusion_one_click_checkout_module_right_header">
            <p class="get_pro">
                <a href="https://wcfusion.com" target="_blank">Get Pro</a>
            </p>
        </div>
    </div>
    <div class="wcfusion_one_click_checkout_single_module_title">
...
<div id="wcfusion_one_click_checkout_container" style="display: none;">
